$url = Invoke-WebRequest -Uri "https://stream-manager.yy.com/v3/channel/streams?uid=0&cid=54880976&sid=54880976&appid=0&sequence=1632705735370&encode=json" `
-Method "POST" `
-Headers @{
"method"="POST"
